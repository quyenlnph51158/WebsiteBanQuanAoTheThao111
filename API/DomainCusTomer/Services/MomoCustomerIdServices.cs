...
{
    public class MomoCustomerIdServices : IMomoCustomerIdServices
    {
        private readonly IOptions<MomoOptionModelId> _options;

        public MomoCustomerIdServices(IOptions<MomoOptionModelId> options)
        {
            _options = options;
        }
